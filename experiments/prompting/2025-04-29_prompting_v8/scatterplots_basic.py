...
RESULT_FILE_DETAILS = {
    "header": ["level", "transcript_file", "randseed", "pred.total_score", "pred.task_fulfillment", "pred.interaction", "pred.lexical_resource", "pred.grammatical_accuracy"],
}
THRESHOLDS = {
...
def evaluate_and_plot_selected(ax, df, level=None, modelid=None):
    ...
    sns.scatterplot(x="avg.etalon_perc", y="pred.total_score", hue="is_complete", hue_order=[True, False], data=df, ax=ax)
...
def evaluate_all(df, output_file):
    ...
    fig, axs = plt.subplots(len(levels), len(modelids), figsize=(10, 30), squeeze=False)
    # set figsize
...
if __name__ == '__main__':
    ...
    #    "pred.total_score": "mean",
    #    "pred.task_fulfillment": "mean",
    #    "pred.interaction": "mean",
    #    "pred.lexical_resource": "mean",
    #    "pred.grammatical_accuracy": "mean",
    #    "is_complete": "first",
    #}).reset_index()
